...
// canceled.
func http2awaitRequestCancel(req *http.Request, done <-chan struct{}) error {
	ctx := req.Context()
...
func http2shouldRetryRequest(req *http.Request, err error, afterBodyWrite bool) (*http.Request, error) {
...
func (cc *http2ClientConn) roundTrip(req *http.Request) (res *http.Response, gotErrAfterReqBodyWrite bool, err error) {
	...
	handleReadLoopResponse := func(re http2resAndError) (*http.Response, bool, error) {
		res := re.res
...
// Must hold cc.mu.
func (cc *http2ClientConn) awaitOpenSlotForRequest(req *http.Request) error {
...
// requires cc.mu be held.
func (cc *http2ClientConn) encodeTrailers(req *http.Request) ([]byte, error) {
	cc.hbuf.Reset()
